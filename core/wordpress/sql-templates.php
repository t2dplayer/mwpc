...
class SQLTemplates {
    ...
    protected static $sql_map = [
        ...
        'select_detail_join'=>'SELECT detail.name FROM %detailtable as detail inner join %mastertable as master on detail.%detailfield_id = master.id where detail.%itemfield_id = %itemvalue;',
